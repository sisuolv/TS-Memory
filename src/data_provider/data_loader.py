...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 percent=100, max_len=-1, train_all=False, train_ratio = 1.0 ,model_id ='', return_index=False, return_feature_id=False, split_features: bool = True):
        ...
        self.tot_len = max(0, len(self.data_x) - self.seq_len - self.pred_len + 1)
        if self.max_len is not None and int(self.max_len) > 0:
            self.tot_len = min(self.tot_len, int(self.max_len))
...
class Dataset_ETT_minute(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 percent=100, max_len=-1, train_all=False  , model_id = '', return_index=False, return_feature_id=False, split_features: bool = True):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
...
class Dataset_Custom_S(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=True, timeenc=0, freq='h',
                 percent=10, max_len=-1, train_all=False , train_ratio=1.0 , model_id='', return_index=False, return_feature_id=False, split_features: bool = True):
